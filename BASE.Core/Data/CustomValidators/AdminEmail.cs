...
{
    public class AdminEmailValidator : IValidator
    {

        public AdminEmailValidator(string email)
        {
            this._email = email;
        }
        ...
        void IValidator.Validate()
        {
            ...
            { // not Greater than 0.
                this._isValid = false;
                this._errorMessage = "The admin email is missing.";
                return;
            }
            ...
            { // not Greater or equal to 5 characters. An email even local need at least 5 character.. a@b.c
                this._isValid = false;
                this._errorMessage = "The admin email address is not valid.";
                return;
            }
