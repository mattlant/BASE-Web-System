...
{
    public class DomainNameAddressValidator : IValidator
    {

        public DomainNameAddressValidator(string InternetAddress)
        {
        ...
        void IValidator.Validate()
        {
            ...
            { // not Greater than 2.
                ...
                this._isValid = false;
                this._errorMessage = "The Domain Name is not valid.";
                return;
            }
            ...
            #region 2) Checking for a valid domain name address by regexp
            ...
            { // The data is not a valid domain name neither...
               ...
               // The data is an Domain Name Address and it is valid by regexp.
