...
{
    public class NameServerAddressValidator : IValidator
    {

        public NameServerAddressValidator(string InternetAddress)
        {
        ...
        void IValidator.Validate()
        {
            ...
            { // not Greater than 2.
                ...
                this._isValid = false;
                this._errorMessage = "The Name Server address is not valid.";
                return;
            }
